...
**Fontawesome has done their very best to make Fontawesome 6 compatible with Fontawesome 5**

This means that upgrading to Fontawesome 6 will not affect websites that depend on Joomla to deliver Fontawesome 5 icons, actually Joomla users will get the new and improved Fontawesome 6 icons without having to update their code at all.
